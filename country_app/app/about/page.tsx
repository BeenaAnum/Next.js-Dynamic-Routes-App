...
export default function About(){
    return( 
     <div>
       ...
       <p className="flex justify-center item-center m-2 text-black font-bold text-center"> My name is Beena Anum,I am Web Developer Specializing in
       ...
       you can find me via email Ggmail and other at LinkedIn.
       </p>
     </div>
