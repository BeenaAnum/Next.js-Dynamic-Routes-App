...
export default function CountryDetails({ params }:{params :{country_name:string}}) {
  ...
  if (!country) {
    ...
    return <div><h1 className="flex justify-center items-center m-2"><b>Country not found</b></h1>
     <div className="flex justify-center items-center">
      ...
      <Link href="/country">Back to Country List</Link></button>
     </div>
  </div>;
  ...
  return (
    <div>
      <h1 className="flex justify-center items-center">Country: {country.name}</h1>
      <p className="flex justify-center items-center">Population: {country.population}</p>
      <p className="flex justify-center items-center">Capital: {country.capital}</p>
    <div className="flex justify-center items-center">
